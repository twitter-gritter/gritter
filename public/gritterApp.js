...
var GritterApp = React.createClass({
	propTypes: {
	...
	return (
		...
		<p> Searching Twitter for: {this.state.keyword}</p>
			<GritterSearchBar onKeywordSubmit={this.onKeywordSubmit}/>
			<GritterBox tweetsArray={this.state.tweets}/>
		</div>
		)
	}
});

React.render(<GritterApp url = "/api/tweets/"/>,
	document.getElementById ('gritterapp'));
